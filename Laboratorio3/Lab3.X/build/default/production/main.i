...
loop:
    ...
    btfss PORTA, 0 ; ((PORTA) and 07Fh), 0 --> PB1
    call Increase_1 ; Llamando al aumentador

    btfss PORTA, 1 ; ((PORTA) and 07Fh), 1 --> PB2
    call Decrease_1 ; LLamando al decresor

    btfss ((INTCON) and 07Fh), 2 ; Suma cuando llegue al overflow el timer0
    goto $-1
...
Resett:
    ...
    movwf TMR0
    bcf ((INTCON) and 07Fh), 2 ; Bit de overflow == 0
