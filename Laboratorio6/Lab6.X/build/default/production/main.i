...
Isr:
    BANKSEL PORTB ;
    btfsc ((PIR1) and 07Fh), 0 ; Chequeando overflow en Timer1
    call int_Timer1 ; Llamando subrutina de interrupción de Timer1
    btfsc ((INTCON) and 07Fh), 2 ; Chequeando overflow en Timer0
    call int_Timer0 ; Llamando subrutina de interrupción de Timer0
    BANKSEL PIR1 ;
    btfsc ((PIR1) and 07Fh), 1 ; Chequeando overflow en Timer2
    call int_Timer2 ; Llamando subrutina de interrupción de Timer2
    BANKSEL TMR2 ;
    bcf ((PIR1) and 07Fh), 1 ; Bandera ((PIR1) and 07Fh), 1 == 0
...
config_int:
    ...
    BANKSEL INTCON
    bsf ((INTCON) and 07Fh), 7 ; Interrupción global
    bsf ((INTCON) and 07Fh), 5 ; Interrupción de Timer0
    bcf ((INTCON) and 07Fh), 2 ; Interrupción de Timer0

    BANKSEL PIE1
    bsf ((PIE1) and 07Fh), 1 ; Timer2 para PR2 == 1
    bsf ((PIE1) and 07Fh), 0 ; Interrupción por overflow en Timer1 == 1

    BANKSEL PIR1
    bcf ((PIR1) and 07Fh), 1 ; Limpieza de banderas de Timer2
    bcf ((PIR1) and 07Fh), 0 ; Limpieza de banderas de interrupciones de Timer1
    return
...
config_Timer0:
    ...
    bcf ((OPTION_REG) and 07Fh), 3 ; Preescaler de 1:256
...
config_Timer1:
    ...
    BANKSEL T1CON
    bsf ((T1CON) and 07Fh), 5 ; Preescaler de 1:8
    bsf ((T1CON) and 07Fh), 4 ;
    bcf ((T1CON) and 07Fh), 1 ; Reloj interno == 1
    bsf ((T1CON) and 07Fh), 0 ; Timer1 == 1
